...
describe("modify", () => {
  describe("addSquare", () => {
    ...
    it("works correctly when i < 0", () => {
      expect(toString(addSquare(mino, [-1, 0]))).toEqual("100_111_001")
    })

    it("works correctly when j < 0", () => {
      expect(toString(addSquare(mino, [0, -1]))).toEqual("1000_1111")
    })

    it("works correctly when j === width", () => {
      expect(toString(addSquare(mino, [0, 3]))).toEqual("0100_1111")
    })
  })
